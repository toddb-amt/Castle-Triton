...
- [x] **AMT-01** · MED (business rule) · `Fragment_page_amount_selection.showCustomAmountDialog`, `AmountRounding` — **shipped 6.2.7** (user 2026-09-25: "it should round to the minimum… 12.50 goes to 20")
